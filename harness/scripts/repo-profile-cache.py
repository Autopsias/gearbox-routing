...
Adapted 2026-07-09 from everyinc/compound-engineering-plugin
(skills/ce-plan/scripts/repo-profile-cache.py, MIT License,
Copyright (c) 2025 Every). Changes: cache root moved to
/tmp/claude-repo-profile. Consumers: plan-harden Phase 0, plan-builder
interview grounding.
...
CACHE_ROOT = "/tmp/claude-repo-profile"
