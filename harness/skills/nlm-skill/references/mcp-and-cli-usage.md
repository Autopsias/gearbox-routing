# NotebookLM command categories — MCP tools + CLI usage per category

## Contents
- [2. Notebook Management](#2-notebook-management)
- [3. Source Management](#3-source-management)
- [4. Research (Source Discovery)](#4-research-source-discovery)
- [5. Content Generation (Studio)](#5-content-generation-studio)
- [6. Studio (Artifact Management)](#6-studio-artifact-management)
- [Renaming Resources](#renaming-resources)
- [Server Info (Version Check)](#server-info-version-check)
- [7. Chat Configuration and Notes](#7-chat-configuration-and-notes)
- [8. Notebook Sharing](#8-notebook-sharing)
- [9. Aliases (UUID Shortcuts)](#9-aliases-uuid-shortcuts)
- [10. Configuration](#10-configuration)
- [11. Skill Management](#11-skill-management)

Read this when you need the detailed per-category MCP-tool names and CLI command
patterns for notebook/source/research/generation/studio/download/export/sharing/
note/chat/alias/config/skill-management operations. SKILL.md keeps only auth, quick
reference, the decision tree, critical rules, output formats, common patterns, and
error recovery — everything category-specific lives here. For raw CLI flag signatures
(not cross-referenced to MCP tool names), see
[command_reference.md](command_reference.md) instead — that file is the flag-level
reference; this file is the MCP+CLI usage-pattern reference per category.
