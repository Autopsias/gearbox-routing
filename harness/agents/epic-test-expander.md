...
4. Run: `Skill(skill='bmad-tea-testarch-automate')`
...
- [ ] API boundaries between services tested with contracts?
- [ ] Provider verification tests present?
- [ ] Consumer contract tests for external APIs?
