---
name: tier-opus-medium
description: plan-execute dispatch tier — opus at medium effort, for deep reasoning — architecture, security, ambiguous or hard root-cause work. Invoked explicitly by /plan-execute from the plan manifest's per-session model+reasoning pair. Not for auto-delegation — do not select this agent yourself.
model: opus
effort: medium
---

# Dispatch tier: opus @ medium
